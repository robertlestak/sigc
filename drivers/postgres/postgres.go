...
func (d *Postgres) parseParams(params map[string]any) error {
...
func (d *Postgres) Connect(params map[string]any) error {
	l := log.WithFields(log.Fields{
		"app": "postgres",
		"fn":  "Connect",
	})
...
func (d *Postgres) Exec(r *schema.Request) *schema.Response {
	l := log.WithFields(log.Fields{
		"app": "postgres",
		"fn":  "Exec",
	})
